...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: `Un test de personnalité olfactive pour faire ressortir un profil et trouver jusqu'à 3 parfums cohérents sur ${project.title}.`,
  };
}
      ...
      <div className="mx-auto max-w-5xl space-y-8">
        <div className="space-y-3">
          ...
          <h1 className="font-serif text-4xl text-zinc-900 md:text-5xl">
            Trouve le profil olfactif qui te ressemble.
          </h1>
          <p className="max-w-3xl text-sm leading-7 text-zinc-600 md:text-base">
            Le parcours prend le temps de comprendre tes goûts, ton usage et ta personnalité, puis fait ressortir un profil principal avant de proposer jusqu'à 3 parfums cohérents.
          </p>
        </div>
