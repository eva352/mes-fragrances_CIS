        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:gap-10 lg:grid-cols-2 lg:grid-rows-[min-content_1fr]">
          ...
          <div className="order-3 my-6 md:order-none">
            ...
            <div className="grid grid-cols-2 place-items-center gap-8 md:grid-cols-4">
              <img
                src="/blocks/contact/contact-17/fictional-company-logo-1.svg"
                alt="placeholder"
                className="max-w-24 dark:invert"
              />
              <img
                src="/blocks/contact/contact-17/fictional-company-logo-2.svg"
                alt="placeholder"
                className="max-w-24 dark:invert"
              />
              <img
                src="/blocks/contact/contact-17/fictional-company-logo-3.svg"
                alt="placeholder"
                className="max-w-24 dark:invert"
              />
              <img
                src="/blocks/contact/contact-17/fictional-company-logo-4.svg"
                alt="placeholder"
                className="max-w-24 dark:invert"
              />
              <img
                src="/blocks/contact/contact-17/fictional-company-logo-5.svg"
                alt="placeholder"
                className="max-w-24 dark:invert"
              />
              <img
                src="/blocks/contact/contact-17/fictional-company-logo-6.svg"
                alt="placeholder"
                className="max-w-24 dark:invert"
              />
              <img
                src="/blocks/contact/contact-17/fictional-company-logo-7.svg"
                alt="placeholder"
                className="max-w-24 dark:invert"
              />
              <img
                src="/blocks/contact/contact-17/fictional-company-logo-8.svg"
                alt="placeholder"
                className="max-w-24 dark:invert"
              />
            </div>
