          ...
          <div className="hidden md:block">
            <div className="space-y-16 pb-20 lg:pb-0">
              <div className="space-y-6">
                <div className="mt-16 flex overflow-hidden">
                  <Avatar className="size-11">
                    <AvatarImage src="/blocks/contact/contact-1/avatar-1.webp" />
                    <AvatarFallback>SB</AvatarFallback>
                  </Avatar>
                  <Avatar className="-ml-4 size-11">
                    <AvatarImage src="/blocks/contact/contact-1/avatar-3.webp" />
                    <AvatarFallback>RA</AvatarFallback>
                  </Avatar>
                  <Avatar className="-ml-4 size-11">
                    <AvatarImage src="/blocks/contact/contact-1/avatar-2.webp" />
              ...
              <div className="flex items-center space-x-12">
                <img
                  src="/blocks/contact/contact-1/astro-wordmark.svg"
                  alt="placeholder"
                  className="h-6 dark:invert"
                />
                <img
                  src="/blocks/contact/contact-1/shadcn-ui-wordmark.svg"
                  alt="placeholder"
