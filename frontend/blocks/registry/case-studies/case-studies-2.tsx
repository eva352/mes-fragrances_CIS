        ...
        <div className="mt-20">
          <div className="grid gap-16 lg:grid-cols-3 xl:gap-24">
            <div className="flex flex-col gap-10 border-border sm:flex-row lg:col-span-2 lg:border-r lg:pr-16 xl:pr-24">
              <img
                src="/blocks/case-studies/case-studies-2/placeholder-1.svg"
                alt="placeholder"
              ...
              <div className="flex h-full flex-col justify-between gap-10">
                ...
                <div className="flex items-end gap-6">
                  ...
                  <img
                    src="/blocks/case-studies/case-studies-2/fictional-company-logo-2.svg"
                    alt="logo"
                  />
                </div>
              </div>
          ...
          <div className="grid gap-16 lg:grid-cols-3 xl:gap-24">
            <div className="flex flex-col gap-10 border-border sm:flex-row lg:col-span-2 lg:border-r lg:pr-16 xl:pr-24">
              <img
                src="/blocks/case-studies/case-studies-2/placeholder-2.svg"
                alt="placeholder"
                className="aspect-[29/35] h-full w-full max-w-60 rounded-2xl object-cover"
              />
              <div className="flex h-full flex-col justify-between gap-10">
                ...
                <div className="flex items-end gap-6">
                  ...
                  <img
                    src="/blocks/case-studies/case-studies-2/fictional-company-logo-3.svg"
                    alt="logo"
                  />
                </div>
              </div>
