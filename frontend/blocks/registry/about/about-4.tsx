          ...
          <div className="container flex flex-col items-center gap-11">
            ...
            <div className="grid grid-cols-2 gap-x-7 gap-y-12 lg:grid-cols-4">
              <div className="flex items-center gap-3">
                <img
                  src="/blocks/about/about-4/block-1.svg"
                  alt="logo"
              ...
              <div className="flex items-center gap-3">
                <img
                  src="/blocks/about/about-4/block-2.svg"
                  alt="logo"
                  className="h-8 w-auto md:h-14"
                />
              ...
              <div className="flex items-center gap-3">
                <img
                  src="/blocks/about/about-4/block-3.svg"
                  alt="logo"
                  className="h-8 w-auto md:h-14"
                />
              ...
              <div className="flex items-center gap-3">
                <img
                  src="/blocks/about/about-4/block-4.svg"
                  alt="logo"
                  className="h-8 w-auto md:h-14"
                />
              ...
              <div className="flex items-center gap-3">
                <img
                  src="/blocks/about/about-4/block-5.svg"
                  alt="logo"
                  className="h-8 w-auto md:h-14"
                />
              ...
              <div className="flex items-center gap-3">
                <img
                  src="/blocks/about/about-4/block-6.svg"
                  alt="logo"
                  className="h-8 w-auto md:h-14"
                />
