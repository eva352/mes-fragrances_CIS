      ...
      <div className="container">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8 flex justify-center">
            <img
              src="/blocks/about/about-9/nubelson-fernandes-tAJYoec13xk-unsplash.jpg"
              alt="Team at work"
          ...
          <div className="mx-auto mb-16 flex w-full max-w-6xl flex-col justify-between gap-12 md:flex-row">
            <div className="text-base font-medium">
              ...
              <span className="font-semibold text-foreground">
                San Francisco CA
                <img
                  src="/blocks/about/about-9/united-states.png"
                  alt="United States"
                  className="h-4 w-4"
                />
              </span>
            ...
            <div className="mt-8 w-full md:mt-0 md:w-2/3">
              ...
              <div className="mt-12">
                <img
                  src="/blocks/about/about-9/nastuh-abootalebi-eHD8Y1Znfpk-unsplash.jpg"
