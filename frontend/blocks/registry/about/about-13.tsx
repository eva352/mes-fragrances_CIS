  ...
  return (
    <section className={cn("py-32", className)}>
      <div className="container space-y-10 lg:space-y-20">
        ...
        <div className="grid-cols-6 space-y-12 lg:grid lg:space-y-0 xl:gap-10">
          ...
          <div className="col-span-2 lg:pr-24 lg:pl-10">
            ...
            <div className="mt-5 flex items-center gap-5 lg:mt-20">
              <img
                src="/blocks/about/about-13/avatar1.png"
                className="size-12"
                alt="avatr"
              />
              <div>
          ...
          <div className="col-span-3 mt-32 lg:mt-0 lg:pl-10">
            ...
            <p className="mt-6 text-base text-foreground/40 lg:mt-[4.5rem] lg:text-lg">
        ...
        <div>
          <img
            src="/blocks/about/about-13/img10.png"
            alt="about us iamge"
            className="mt-4 h-[600px] w-full object-cover"
          />
        </div>
      </div>
    </section>
