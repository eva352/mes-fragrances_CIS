      ...
      <div className="container">
        ...
        <div className="grid gap-5 pt-14 xl:grid-cols-3">
          <a href="#" className="group relative overflow-hidden rounded-xl">
            <img
              src="/blocks/features/feature-117/photo-1563952532949-3d1a874ad614"
              alt="placeholder"
          ...
          <a href="#" className="group relative overflow-hidden rounded-xl">
            <img
              src="/blocks/features/feature-117/photo-1653288973812-81d1951b8127"
              alt="placeholder"
              className="h-full max-h-[450px] w-full rounded-xl object-cover object-center"
            />
            <div className="absolute top-0 right-0 bottom-0 left-0 translate-y-20 rounded-xl bg-gradient-to-t from-primary to-transparent transition-transform duration-300 group-hover:translate-y-0"></div>
            <div className="absolute top-0 flex h-full w-full flex-col justify-between p-7">
              <span className="ml-auto flex w-fit items-center gap-2 rounded-full bg-background/30 px-4 py-2.5 text-sm font-semibold backdrop-blur-sm">
                <Avatar className="size-7 rounded-full">
                  <AvatarImage
                    src="/blocks/features/feature-117/avatar-1.webp"
                    alt="placeholder"
                  />
                </Avatar>
          ...
          <a href="#" className="group relative overflow-hidden rounded-xl">
            <img
              src="/blocks/features/feature-117/photo-1647715360138-33fb6fe68539"
              alt="placeholder"
              className="h-full max-h-[450px] w-full rounded-xl object-cover object-center"
            />
            <div className="absolute top-0 right-0 bottom-0 left-0 translate-y-20 rounded-xl bg-gradient-to-t from-primary to-transparent transition-transform duration-300 group-hover:translate-y-0"></div>
