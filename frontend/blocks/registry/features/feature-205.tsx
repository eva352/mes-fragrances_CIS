          ...
          <div>
            ...
            >
              <div className="relative">
                <img
                  src="/blocks/features/feature-205/annie-spratt-hCb3lIB8L8E-unsplash.jpg"
                  alt="placeholder"
            ...
            >
              <div className="relative">
                <img
                  src="/blocks/features/feature-205/annie-spratt-MChSQHxGZrQ-unsplash.jpg"
                  alt="placeholder"
                  className="h-[440px] w-full rounded-3xl object-cover lg:h-[540px]"
                />
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-tr from-primary/80 via-transparent to-transparent" />
            ...
            >
              <div className="relative">
                <img
                  src="/blocks/features/feature-205/annie-spratt-AkftcHujUmk-unsplash.jpg"
                  alt="placeholder"
                  className="h-[440px] w-full rounded-3xl object-cover lg:h-[540px]"
                />
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-tr from-primary/80 via-transparent to-transparent" />
