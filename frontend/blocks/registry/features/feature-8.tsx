        ...
        <div className="mt-16 flex flex-col justify-between gap-6 md:flex-row lg:mt-20 lg:gap-10">
          <Card className="group p-6">
            ...
            <div className="mt-10 flex items-center justify-between">
              ...
              <img
                src="/blocks/features/feature-8/shadcn-ui-wordmark.svg"
                alt="shadcn"
          ...
          <Card className="group p-6">
            ...
            <div className="mt-10 flex items-center justify-between">
              ...
              <img
                src="/blocks/features/feature-8/tailwind-wordmark-light.svg"
                alt="shadcn"
                className="h-4 dark:hidden"
              />
              <img
                src="/blocks/features/feature-8/tailwind-wordmark-dark.svg"
                alt="shadcn"
