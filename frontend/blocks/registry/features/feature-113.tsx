          ...
          <Tabs defaultValue="tab-1" className="mt-14">
            ...
            <div className="container mt-10 max-w-7xl rounded-2xl bg-muted/70 p-8 md:mt-14 lg:p-16">
              ...
              >
                ...
                <img
                  src="/blocks/features/feature-113/placeholder-dark-1.svg"
                  alt="placeholder"
              ...
              >
                ...
                <img
                  src="/blocks/features/feature-113/placeholder-dark-2.svg"
                  alt="placeholder"
                  className="max-h-96 rounded-xl"
                />
              </TabsContent>
              ...
              >
                ...
                <img
                  src="/blocks/features/feature-113/placeholder-dark-3.svg"
                  alt="placeholder"
                  className="max-h-96 rounded-xl"
                />
              </TabsContent>
