      ...
      <div className="container">
        <div className="flex flex-col gap-8 md:flex-row">
          <div className="aspect-[5/6] overflow-clip rounded-3xl bg-accent">
            <img
              src="/blocks/features/feature-80/placeholder-1.svg"
              alt="placeholder"
            ...
            <div className="flex flex-col gap-6 md:flex-row">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center">
                    <Avatar className="size-10">
                      <AvatarImage src="/blocks/features/feature-80/avatar-1.webp" />
                      <AvatarFallback>SB</AvatarFallback>
                    </Avatar>
                    <Avatar className="-ml-3 size-10">
                      <AvatarImage src="/blocks/features/feature-80/avatar-3.webp" />
                      <AvatarFallback>RA</AvatarFallback>
                    </Avatar>
                    <Avatar className="-ml-3 size-10">
                      <AvatarImage src="/blocks/features/feature-80/avatar-2.webp" />
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-center">
                    <img
                      src="/blocks/features/feature-80/block-1.svg"
