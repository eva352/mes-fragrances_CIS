      ...
      <div className="container">
        ...
        <div className="mt-16 flex flex-col overflow-hidden rounded-2xl bg-muted md:flex-row">
          <div className="flex w-full items-center bg-muted md:w-1/2">
            <img
              src="/blocks/features/feature-138/placeholder-dark-1.svg"
              alt="placeholder"
        ...
        <div className="mt-16 flex flex-col overflow-hidden rounded-2xl bg-muted md:flex-row">
          ...
          <div className="flex w-full items-center bg-muted md:w-1/2">
            <img
              src="/blocks/features/feature-138/placeholder-dark-2.svg"
              alt="placeholder"
              className="max-h-64 w-full object-cover"
            />
          </div>
        ...
        <div className="mt-16 flex flex-col overflow-hidden rounded-2xl bg-muted md:flex-row">
          <div className="flex w-full items-center bg-muted md:w-1/2">
            <img
              src="/blocks/features/feature-138/placeholder-dark-3.svg"
              alt="placeholder"
              className="max-h-64 w-full object-cover"
            />
          </div>
