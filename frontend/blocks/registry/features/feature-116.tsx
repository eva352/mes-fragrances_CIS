    ...
    <section className={cn("py-32", className)}>
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-y-5 pt-14 xl:grid-cols-3 xl:grid-rows-2 xl:gap-x-5 xl:gap-y-0">
          ...
          >
            <img
              src="/blocks/features/feature-116/photo-1653288973812-81d1951b8127"
              alt="placeholder"
          ...
          <div className="grid gap-y-5 xl:row-span-2">
            <a href="#" className="group relative overflow-hidden rounded-xl">
              <img
                src="/blocks/features/feature-116/photo-1647715360138-33fb6fe68539"
                alt="placeholder"
            ...
            >
              <img
                src="/blocks/features/feature-116/photo-1563952532949-3d1a874ad614"
                alt="placeholder"
