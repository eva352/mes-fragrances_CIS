...
const integrations = [
  {
    image: "/blocks/features/feature-153/shadcn-ui-icon.svg",
    title: "Shadcn UI",
    description:
  ...
  {
    image: "/blocks/features/feature-153/figma-icon.svg",
    title: "Figma",
    description:
  ...
  {
    image: "/blocks/features/feature-153/tailwind-icon.svg",
    title: "Tailwind",
    description:
  ...
  {
    image: "/blocks/features/feature-153/google-icon.svg",
    title: "Google",
    description:
      ...
      <div className="container">
        ...
        >
          ...
          <div className="relative">
            <CarouselContent
              className="ml-6 pt-[5px] pb-5 transition-all duration-300"
              style={{
