...
const Feature23 = ({ className }: Feature23Props) => {
  return (
        ...
        <div className="mt-20 grid gap-10 lg:grid-cols-3 xl:gap-20">
          <div className="flex flex-col lg:block">
            <div className="h-full max-h-[500px] rounded-lg border bg-muted p-3">
              <img
                src="/blocks/features/feature-23/placeholder-dark-1.svg"
                alt="placeholder"
          ...
          <div className="flex flex-col lg:block">
            <div className="h-full max-h-[500px] rounded-lg border bg-muted p-3">
              <img
                src="/blocks/features/feature-23/placeholder-dark-2.svg"
                alt="placeholder"
                className="h-full w-full rounded-lg object-cover"
              />
            </div>
          ...
          <div className="flex flex-col lg:block">
            <div className="h-full max-h-[500px] rounded-lg border bg-muted p-3">
              <img
                src="/blocks/features/feature-23/placeholder-dark-3.svg"
                alt="placeholder"
                className="h-full w-full rounded-lg object-cover"
              />
            </div>
