      ...
      <div className="container">
        <div className="relative">
          ...
          <div className="absolute -top-15 -right-10 hidden transition-all ease-in-out group-hover:-rotate-0 lg:block">
            <img
              src="/blocks/features/feature-241/tokyo-browser-window-with-tab-bars.svg"
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          {teamFeatures.map((feature) => {
            ...
            return (
              ...
              >
                <Card className="group relative rounded-none! border border-border bg-background p-6 shadow-none transition-all duration-500 ease-in-out hover:bg-gradient-to-l hover:from-transparent hover:to-muted">
