      ...
      <div className="container">
        ...
        <div className="mx-auto mt-20 flex max-w-5xl grid-cols-1 flex-col gap-6 lg:grid lg:grid-cols-7">
          ...
          >
            ...
            <img
              src="/blocks/features/feature-50/placeholder-dark-1.svg"
              alt="placeholder"
          ...
          >
            ...
            <img
              src="/blocks/features/feature-50/placeholder-dark-2.svg"
              alt="placeholder"
          ...
          >
            <img
              src="/blocks/features/feature-50/placeholder-dark-3.svg"
              alt="placeholder"
