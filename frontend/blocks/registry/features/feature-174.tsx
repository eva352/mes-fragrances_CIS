...
const Item = ({
  ...
  return (
    ...
    >
      ...
      >
        {fade.includes("right") && (
          <div className="absolute inset-0 z-10 bg-gradient-to-r from-transparent via-transparent to-background" />
        )}
        {fade.includes("bottom") && (
          <div className="absolute inset-0 z-10 bg-gradient-to-b from-transparent via-transparent to-background" />
        )}
        {fade.includes("top") && (
          <div className="absolute inset-0 z-10 bg-gradient-to-t from-transparent via-transparent to-background" />
        )}
        <img
          src={image.src}
          alt={image.alt}
