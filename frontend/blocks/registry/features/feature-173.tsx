      ...
      <div className="container">
        ...
        <div className="mt-8 grid gap-5 sm:grid-cols-2 md:mt-12 lg:mt-20 lg:grid-cols-3">
          {ITEMS.map((metric, i) => (
            <div
              key={i}
              className="relative flex [aspect-ratio:3.5/2.6] flex-col justify-between overflow-hidden rounded-[24px] bg-gradient-to-b from-muted to-[#D6E3DF] md:[aspect-ratio:3.8/5] dark:to-[#2A3633]"
            >
