...
const DATA: DataItem[] = [
  {
    ...
    image: "/blocks/features/feature-182/placeholder-1.svg",
  ...
  },
  {
    ...
    image: "/blocks/features/feature-182/placeholder-2.svg",
  ...
  },
  {
    ...
    image: "/blocks/features/feature-182/placeholder-3.svg",
    icon: <Sparkle className="size-6" />,
  },
];

interface Feature182Props {
  className?: string;
}
