        ...
        <div className="mt-10 mb-8 grid gap-7 lg:grid-cols-3">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2 text-xl font-semibold">
              <img
                src="/blocks/features/feature-92/figma-icon.svg"
                alt="shadcn"
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2 text-xl font-semibold">
              <img
                src="/blocks/features/feature-92/tailwind-icon.svg"
                alt="shadcn"
                className="h-5 w-auto"
              />
              TailwindCSS
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2 text-xl font-semibold">
              <img
                src="/blocks/features/feature-92/shadcn-ui-icon.svg"
                alt="shadcn"
                className="h-5 w-auto"
              />
              shadcn/ui
