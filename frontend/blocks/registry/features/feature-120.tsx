    ...
    <section className={cn("py-32", className)}>
      <div className="container">
        <div className="grid items-center gap-10 md:gap-20 lg:grid-cols-2">
            ...
            <div className="flex flex-col gap-6 py-10 sm:flex-row sm:gap-16">
              <div className="flex gap-4 leading-5">
                <Avatar className="size-9 rounded-full ring-1 ring-input">
                  <AvatarImage src="/blocks/features/feature-120/avatar-1.webp" alt="avatar" />
                </Avatar>
              ...
              <div className="flex gap-4 leading-5">
                <Avatar className="size-9 rounded-full ring-1 ring-input">
                  <AvatarImage src="/blocks/features/feature-120/avatar-2.webp" alt="avatar" />
                </Avatar>
                <div className="text-sm">
          ...
          <img
            src="/blocks/features/feature-120/placeholder-1.svg"
            alt="placeholder"
