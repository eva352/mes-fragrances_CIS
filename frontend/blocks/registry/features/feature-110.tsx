                ...
                <CarouselContent className="">
                  <CarouselItem className="w-fit basis-auto sm:basis-1/5">
                    <Avatar className="size-14 rounded-full ring-1 ring-input">
                      <AvatarImage
                        src="/blocks/features/feature-110/avatar-1.webp"
                        alt="placeholder"
                      />
                    </Avatar>
                  </CarouselItem>
                  <CarouselItem className="w-fit basis-auto sm:basis-1/5">
                    <Avatar className="size-14 rounded-full ring-1 ring-input">
                      <AvatarImage
                        src="/blocks/features/feature-110/avatar-2.webp"
                        alt="placeholder"
                      />
                    </Avatar>
                  </CarouselItem>
                  <CarouselItem className="w-fit basis-auto sm:basis-1/5">
                    <Avatar className="size-14 rounded-full ring-1 ring-input">
                      <AvatarImage
                        src="/blocks/features/feature-110/avatar-3.webp"
                        alt="placeholder"
                      />
                    </Avatar>
                  </CarouselItem>
                  <CarouselItem className="w-fit basis-auto sm:basis-1/5">
                    <Avatar className="size-14 rounded-full ring-1 ring-input">
                      <AvatarImage
                        src="/blocks/features/feature-110/avatar-4.webp"
                        alt="placeholder"
                      />
                    </Avatar>
                  </CarouselItem>
                  <CarouselItem className="w-fit basis-auto sm:basis-1/5">
                    <Avatar className="size-14 rounded-full ring-1 ring-input">
                      <AvatarImage
                        src="/blocks/features/feature-110/avatar-5.webp"
                        alt="placeholder"
                      />
                    </Avatar>
                  </CarouselItem>
                  <CarouselItem className="w-fit basis-auto sm:basis-1/5">
                    <Avatar className="size-14 rounded-full ring-1 ring-input">
                      <AvatarImage
                        src="/blocks/features/feature-110/avatar-6.webp"
                        alt="placeholder"
                      />
                    </Avatar>
                  </CarouselItem>
                  <CarouselItem className="w-fit basis-auto sm:basis-1/5">
                    <Avatar className="size-14 rounded-full ring-1 ring-input">
                      <AvatarImage
                        src="/blocks/features/feature-110/avatar-7.webp"
                        alt="placeholder"
                      />
                    </Avatar>
                  </CarouselItem>
                </CarouselContent>
                <div className="absolute inset-0 bg-gradient-to-r from-muted via-transparent to-muted"></div>
              </Carousel>
            </div>
          </div>
          <div className="flex flex-col gap-7">
