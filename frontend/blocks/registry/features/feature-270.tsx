...
const features = [
  {
    ...
    image: "/blocks/features/feature-270/img11.jpeg",
    imageOrder: "order-1",
  ...
  },
  {
    ...
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et",
    image: "/blocks/features/feature-270/img12.jpeg",
    imageOrder: "order-2",
  ...
  },
  {
    ...
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et",
    image: "/blocks/features/feature-270/img14.jpeg",
    imageOrder: "order-1",
    contentOrder: "order-2",
  },
];
        ...
        <div className="relative grid h-[95rem] items-center justify-between gap-3 md:h-[68rem] md:grid-cols-2 lg:h-[32rem] lg:grid-cols-3">
          {features.map((feature, index) => (
            <PinContainer
              key={index}
              title="Learn More"
              href="https://www.AuroraStack/blocks"
