...
const contributors = [
  {
    name: "Sarah Johnson",
    image: "/blocks/features/feature-255/avatar-1.webp",
  ...
  },
  {
    ...
    image: "/blocks/features/feature-255/avatar-2.webp",
  ...
  {
    name: "Emily Chen",
    image: "/blocks/features/feature-255/avatar-3.webp",
  ...
  {
    name: "David Thompson",
    image: "/blocks/features/feature-255/avatar-4.webp",
  ...
  {
    name: "Luna Patel",
    image: "/blocks/features/feature-255/avatar-5.webp",
  ...
  {
    name: "Alex Kim",
    image: "/blocks/features/feature-255/avatar-6.webp",
                ...
                <div key={idx}>
                  <div className="flex gap-3 md:gap-4">
                    <img
                      ...
                      className="size-10 rounded-lg border border-border md:size-12"
                    />
                    <div>
                      <p className="flex flex-col font-medium md:flex-row md:items-center md:gap-1 md:text-lg">
                        {contributor.name}
                        <span className="text-sm whitespace-nowrap text-muted-foreground md:text-base md:font-normal">
                          {contributor.title}
                        </span>
                      </p>
                  ...
                  <p className="mt-2 text-sm text-muted-foreground md:hidden md:text-base">
                    {contributor.description}
                  </p>
                </div>
              ))}
