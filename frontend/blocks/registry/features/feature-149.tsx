    ...
    <section className={cn("py-12 md:py-32", className)}>
      <div className="container px-4 md:px-6">
        <div className="relative flex flex-col md:flex-row md:gap-0">
          ...
          <img
            src="/blocks/features/feature-149/photo-1653288973812-81d1951b8127"
          ...
          >
            <div className="md:backdrop-blur-0 md:group-hover:backdrop-blur-0 absolute top-0 left-0 z-[-1] h-full w-full rounded-t-[20px] bg-gradient-to-b from-black/40 to-black/30 backdrop-filter transition-all duration-500 ease-out group-hover:from-black/30 group-hover:to-black/20 group-hover:backdrop-blur-[2px] md:rounded-2xl md:from-black/40 md:to-black/30 md:transition-colors md:duration-300 group-hover:md:from-black/50 group-hover:md:to-black/40" />
            <Button
              variant="outline"
          ...
          <div className="relative hidden h-[600px] w-5 bg-background md:block">
            <div className="absolute top-0 left-[-40px] h-[40px] w-[40px] rounded-[1rem] shadow-[10px_-10px_0_0_#fff]" />
            <div className="absolute top-0 right-[-40px] h-[40px] w-[40px] rounded-[1rem] shadow-[-10px_-10px_0_0_#fff]" />
            <div className="absolute bottom-0 left-[-40px] h-[40px] w-[40px] rounded-[1rem] shadow-[10px_10px_0_0_#fff]" />
            <div className="absolute right-[-40px] bottom-0 h-[40px] w-[40px] rounded-[1rem] shadow-[-10px_10px_0_0_#fff]" />
          </div>
          ...
          >
            <div className="md:backdrop-blur-0 md:group-hover:backdrop-blur-0 absolute top-0 left-0 z-[-1] h-full w-full rounded-b-[20px] bg-gradient-to-t from-black/40 to-black/30 backdrop-filter transition-all duration-500 ease-out group-hover:from-black/30 group-hover:to-black/20 group-hover:backdrop-blur-[2px] md:rounded-2xl md:from-black/40 md:to-black/30 md:transition-colors md:duration-300 group-hover:md:from-black/50 group-hover:md:to-black/40" />
            <Button
              variant="outline"
              className="rounded-full border-white/20 bg-background/10 text-white hover:bg-background/20"
            >
