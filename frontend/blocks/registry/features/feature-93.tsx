        ...
        <div className="text-center">
          <span className="flex items-end justify-center -space-x-4">
            <Avatar className="size-16 border">
              <AvatarImage
                src="/blocks/features/feature-93/avatar-1.webp"
                alt="placeholder"
              />
            </Avatar>
            <Avatar className="size-24 border">
              <AvatarImage
                src="/blocks/features/feature-93/avatar-6.webp"
                alt="placeholder"
              />
            </Avatar>
            <Avatar className="size-16 border">
              <AvatarImage
                src="/blocks/features/feature-93/avatar-3.webp"
                alt="placeholder"
              />
            </Avatar>
          </span>
