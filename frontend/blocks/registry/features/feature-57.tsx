...
const features = [
  {
    ...
    icon: Cloud,
    image: "/blocks/features/feature-57/placeholder-1.svg",
  },
  {
    id: "feature-2",
    ...
    description:
      "Nam vitae molestie arcu. Quisque eu libero orci. Aliquam imperdiet magna nec massa consectetur, id interdum ante congue.",
    icon: Star,
    image: "/blocks/features/feature-57/placeholder-2.svg",
  },
  {
    id: "feature-3",
    ...
    description:
      "Nam vitae molestie arcu. Quisque eu libero orci. Aliquam imperdiet magna nec massa consectetur, id interdum ante congue.",
    icon: Bolt,
    image: "/blocks/features/feature-57/placeholder-3.svg",
  },
  {
    id: "feature-4",
    ...
    description:
      "Nam vitae molestie arcu. Quisque eu libero orci. Aliquam imperdiet magna nec massa consectetur, id interdum ante congue.",
    icon: MessagesSquare,
    image: "/blocks/features/feature-57/placeholder-4.svg",
  },
];
                    ...
                    {features.map((feature) => (
                      <CarouselItem key={feature.id} className="px-0">
                        <div className="relative h-full w-full overflow-hidden">
                          ...
                          />
                          <div className="absolute right-0 bottom-0 left-0 bg-gradient-to-t from-background/80 via-background/40 to-transparent p-6">
