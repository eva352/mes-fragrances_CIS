import { ArrowRight, GitCompare } from "@/components/icons";
        ...
        <div className="gap grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          >
            <div className="flex items-center justify-between">
              <span className="grid size-12 shrink-0 place-content-center rounded-md border">
                <img
                  src="/blocks/features/feature-107/block-1.svg"
                  alt="placeholder"
          ...
          >
            <div className="flex items-center justify-between">
              <span className="grid size-12 shrink-0 place-content-center rounded-md border">
                <img
                  src="/blocks/features/feature-107/block-2.svg"
                  alt="placeholder"
                  className="h-auto w-7"
                />
              </span>
          ...
          >
            <div className="flex items-center justify-between">
              <span className="grid size-12 shrink-0 place-content-center rounded-md border">
                <img
                  src="/blocks/features/feature-107/block-3.svg"
                  alt="placeholder"
                  className="h-auto w-7"
                />
              </span>
          ...
          >
            <div className="flex items-center justify-between">
              <span className="grid size-12 shrink-0 place-content-center rounded-md border">
                <img
                  src="/blocks/features/feature-107/block-4.svg"
                  alt="placeholder"
                  className="h-auto w-7"
                />
              </span>
          ...
          >
            <div className="flex items-center justify-between">
              <span className="grid size-12 shrink-0 place-content-center rounded-md border">
                <img
                  src="/blocks/features/feature-107/block-5.svg"
                  alt="placeholder"
                  className="h-auto w-7"
                />
              </span>
          ...
          >
            <div className="flex items-center justify-between">
              <span className="grid size-12 shrink-0 place-content-center rounded-md border">
                <img
                  src="/blocks/features/feature-107/block-6.svg"
                  alt="placeholder"
                  className="h-auto w-7"
                />
              </span>
