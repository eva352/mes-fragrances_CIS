    ...
    <section className={cn("py-32", className)}>
      <div className="container flex flex-col gap-6 lg:px-32">
        <div className="flex flex-col rounded-lg border border-border bg-accent p-8">
          ...
          <img
            src="/blocks/features/feature-56/placeholder-dark-8-wide.svg"
            alt="placeholder"
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="grid-cols-2 gap-x-20 rounded-lg border border-border bg-accent p-6 md:grid md:p-8 lg:flex lg:flex-col">
            ...
            <img
              src="/blocks/features/feature-56/placeholder-dark-1.svg"
              alt="placeholder"
              className="rounded-md lg:mt-auto lg:w-full"
            />
          </div>
          <div className="grid-cols-2 gap-x-20 rounded-lg border border-border bg-accent p-6 md:grid md:p-8 lg:flex lg:flex-col">
            ...
            <img
              src="/blocks/features/feature-56/placeholder-dark-2.svg"
              alt="placeholder"
              className="rounded-md lg:mt-auto lg:w-full"
            />
          </div>
          <div className="grid-cols-2 gap-x-20 rounded-lg border border-border bg-accent p-6 md:grid md:p-8 lg:flex lg:flex-col">
            ...
            <img
              src="/blocks/features/feature-56/placeholder-dark-3.svg"
              alt="placeholder"
              className="rounded-md lg:mt-auto lg:w-full"
            />
          </div>
