      ...
      <div className="container">
        <div className="grid gap-4 md:grid-cols-3">
          <a href="#" className="group relative overflow-hidden rounded-sm">
            <img
              src="/blocks/features/feature-297/kevin-chin-qk4S-s0IX68-unsplash.jpg"
              alt="placeholder"
          ...
          <a href="#" className="group relative overflow-hidden rounded-sm">
            <img
              src="/blocks/features/feature-297/simon-lee-BRHLD4L1Hag-unsplash.jpg"
              alt="placeholder"
              className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105"
            />
            <div className="absolute inset-0 flex flex-col justify-between p-6">
          ...
          <a href="#" className="group relative overflow-hidden rounded-sm">
            <img
              src="/blocks/features/feature-297/simon-lee-R_6A6CovgIM-unsplash.jpg"
              alt="placeholder"
              className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105"
            />
            <div className="absolute inset-0 flex flex-col justify-between p-6">
