...
const FEATURES: FeatureItem[] = [
  {
    ...
    image: "/blocks/features/feature-225/placeholder-1.svg",
  },
  {
    id: "translation",
    title: "Translation",
    ...
    image: "/blocks/features/feature-225/placeholder-2.svg",
  },
  {
    id: "eye-contact",
    title: "Eye Contact",
    ...
    image: "/blocks/features/feature-225/placeholder-3.svg",
  },
  {
    id: "studio-sound",
    title: "Studio Sound",
    ...
    image: "/blocks/features/feature-225/placeholder-4.svg",
  },
  {
    id: "remove-filler",
    ...
    image: "/blocks/features/feature-225/placeholder-5.svg",
  },
  {
    id: "green-screen",
    title: "Green Screen",
    ...
    image: "/blocks/features/feature-225/placeholder-6.svg",
  },
  {
    id: "transcription",
    title: "Transcription",
...
const Feature225 = ({ className }: Feature225Props) => {
  ...
  return (
    <section
      className={cn("w-full bg-background py-12 md:py-24 lg:py-32", className)}
    >
            ...
            <div className="mt-8">
              {FEATURES.map((feature) => (
                <TabsContent
                  key={feature.id}
                  value={feature.id}
                  className="mt-0 rounded-lg border bg-card p-0 shadow-sm"
                >
