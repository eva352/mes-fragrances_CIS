      ...
      <div className="container">
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-t from-background to-transparent to-30%" />
            <div className="absolute inset-0 bg-gradient-to-l from-background to-transparent to-30%" />
            <img
              src="/blocks/features/feature-227/placeholder-1.svg"
              alt="placeholder"
