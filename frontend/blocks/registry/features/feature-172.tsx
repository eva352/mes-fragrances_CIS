...
function Feature172({ className }: Feature172Props) {
  return (
  ...
  return (
    ...
    >
      ...
      {item.fade.includes("bottom") && (
        <div className="absolute inset-0 z-10 bg-gradient-to-t from-background/80 via-transparent to-transparent md:hidden" />
      )}
            ...
            <div className="flex translate-x-4 justify-end gap-5">
              {item.images.slice(0, 4).map((image, j) => (
                ...
                >
                  ...
                  />
                  <div className="absolute inset-y-0 right-0 z-10 w-16 bg-gradient-to-l from-background/80 to-transparent" />
                </div>
              ))}
            </div>
              ...
              {item.images.slice(4).map((image, j) => (
                ...
                >
                  <img
                    ...
                    className="size-8 object-contain object-top-left lg:size-12"
                  />
                  <div className="absolute inset-y-0 bottom-0 left-0 z-10 w-14 bg-gradient-to-r from-background/80 to-transparent" />
                </div>
              ))}
            </div>
          </div>
