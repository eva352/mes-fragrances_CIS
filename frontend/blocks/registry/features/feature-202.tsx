      ...
      <div className="container">
        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-3">
          ...
          >
            ...
            <img
              src="/blocks/features/feature-202/photo-1647517649469-ba454dc72896"
              alt="placeholder"
          ...
          >
            <div className="absolute inset-0 -z-10 bg-gradient-to-t from-primary to-transparent" />
            <img
              src="/blocks/features/feature-202/photo-1698516923132-b0236bc8f3ef"
              alt="placeholder"
              className="absolute inset-0 -z-20 size-full rounded-2xl object-cover grayscale-100 transition-all duration-300 group-hover:grayscale-50"
            />
            <div className="flex h-full flex-col justify-between p-10">
          ...
          >
            <div className="absolute inset-0 -z-10 bg-gradient-to-t from-primary to-transparent" />
            <img
              src="/blocks/features/feature-202/photo-1586869871566-d8e41dd50318"
              alt="placeholder"
              className="absolute inset-0 -z-20 size-full rounded-2xl object-cover grayscale-100 transition-all duration-300 group-hover:grayscale-50"
            />
            <div className="flex h-full flex-col justify-between p-10">
          ...
          >
            <div className="absolute inset-0 -z-10 bg-gradient-to-t from-primary to-transparent" />
            <img
              src="/blocks/features/feature-202/photo-1588742415209-69dbb64791b6"
              alt="placeholder"
              className="absolute inset-0 -z-20 size-full rounded-2xl object-cover grayscale-100 transition-all duration-300 group-hover:grayscale-50"
            />
            <div className="flex h-full flex-col justify-between p-10">
          ...
          >
            <div className="absolute inset-0 -z-10 bg-gradient-to-t from-primary to-transparent" />
            <img
              src="/blocks/features/feature-202/photo-1587278163304-99d65f6a58f0"
              alt="placeholder"
              className="absolute inset-0 -z-20 size-full rounded-2xl object-cover grayscale-100 transition-all duration-300 group-hover:grayscale-50"
            />
            <div className="flex h-full flex-col justify-between p-10">
          ...
          >
            <div className="absolute inset-0 -z-10 bg-gradient-to-t from-primary to-transparent" />
            <img
              src="/blocks/features/feature-202/photo-1589100787575-fad1dcaa9d17"
              alt="placeholder"
              className="absolute inset-0 -z-20 size-full rounded-2xl object-cover grayscale-100 transition-all duration-300 group-hover:grayscale-50"
            />
            <div className="flex h-full flex-col justify-between p-10">
