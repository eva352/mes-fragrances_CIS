            ...
            <TabsList className="relative grid items-start gap-6 lg:grid-cols-4">
              ...
              >
                ...
                <div className="mt-6 block border bg-muted/50 px-4 py-6 lg:hidden">
                  <div className="aspect-video">
                    <img
                      src="/blocks/features/feature-95/placeholder-dark-1.svg"
                      alt="placeholder"
              ...
              >
                ...
                <div className="mt-6 block border bg-muted/50 px-4 py-6 lg:hidden">
                  <div className="aspect-video">
                    <img
                      src="/blocks/features/feature-95/placeholder-dark-2.svg"
                      alt="placeholder"
                      className="h-full w-full rounded-md border object-cover shadow"
                    />
                  </div>
              ...
              >
                ...
                <div className="mt-6 block border bg-muted/50 px-4 py-6 lg:hidden">
                  <div className="aspect-video">
                    <img
                      src="/blocks/features/feature-95/placeholder-dark-3.svg"
                      alt="placeholder"
                      className="h-full w-full rounded-md border object-cover shadow"
                    />
                  </div>
