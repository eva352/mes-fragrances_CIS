...
const DATA = [
  {
    ...
    icon: CircleHelp,
    image: "/blocks/features/feature-169/placeholder-1.svg",
  },
  {
    ...
    icon: Volume2,
    image: "/blocks/features/feature-169/placeholder-2.svg",
  },
  {
    ...
    icon: Lightbulb,
    image: "/blocks/features/feature-169/placeholder-3.svg",
  },
];
          ...
          <TabsList className="relative grid gap-px border-b bg-border md:grid-cols-3">
            {DATA.map((item) => (
              ...
              >
                ...
                <div className="absolute -bottom-px left-0 h-px w-0 bg-gradient-to-r from-blue-600 via-sky-300 to-transparent transition-all duration-300 group-data-[state=active]:w-full" />
              </TabsTrigger>
            ))}
