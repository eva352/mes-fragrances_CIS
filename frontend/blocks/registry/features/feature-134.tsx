        ...
        <div className="mt-14 grid gap-5 lg:grid-cols-3">
          <a href="#" className="flex flex-col rounded-lg border">
            ...
            <div className="rounded-lg p-1">
              <img
                src="/blocks/features/feature-134/placeholder-1.svg"
                alt="placeholder"
          ...
          >
            ...
            <div className="rounded-lg p-1">
              <img
                src="/blocks/features/feature-134/placeholder-2.svg"
                alt="placeholder"
          ...
          <a href="#" className="flex flex-col rounded-lg border">
            ...
            <div className="rounded-lg p-1">
              <img
                src="/blocks/features/feature-134/placeholder-3.svg"
                alt="placeholder"
                className="size-full max-h-72 rounded-lg border object-cover"
              />
            </div>
          ...
          <a href="#" className="flex flex-col rounded-lg border">
            ...
            <div className="rounded-lg p-1">
              <img
                src="/blocks/features/feature-134/placeholder-4.svg"
                alt="placeholder"
                className="size-full max-h-72 rounded-lg border object-cover"
              />
            </div>
          ...
          <a href="#" className="flex flex-col rounded-lg border">
            ...
            <div className="rounded-lg p-1">
              <img
                src="/blocks/features/feature-134/placeholder-5.svg"
                alt="placeholder"
                className="size-full max-h-72 rounded-lg border object-cover"
              />
            </div>
