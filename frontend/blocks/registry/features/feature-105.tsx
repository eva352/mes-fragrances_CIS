          ...
          <Tabs defaultValue="tab-1">
            ...
            <div className="mt-5">
              <TabsContent value="tab-1" className="aspect-video">
                <img
                  src="/blocks/features/feature-105/placeholder-1.svg"
                  alt="placeholder"
              ...
              <TabsContent value="tab-2" className="aspect-video">
                <img
                  src="/blocks/features/feature-105/placeholder-2.svg"
                  alt="placeholder"
                  className="h-full w-full rounded-xl border object-cover"
                />
              </TabsContent>
              <TabsContent value="tab-3" className="aspect-video">
                <img
                  src="/blocks/features/feature-105/placeholder-3.svg"
                  alt="placeholder"
                  className="h-full w-full rounded-xl border object-cover"
                />
              </TabsContent>
              <TabsContent value="tab-4" className="aspect-video">
                <img
                  src="/blocks/features/feature-105/placeholder-4.svg"
                  alt="placeholder"
                  className="h-full w-full rounded-xl border object-cover"
                />
              </TabsContent>
              <TabsContent value="tab-5" className="aspect-video">
                <img
                  src="/blocks/features/feature-105/placeholder-5.svg"
                  alt="placeholder"
                  className="h-full w-full rounded-xl border object-cover"
                />
              </TabsContent>
              <TabsContent value="tab-6" className="aspect-video">
                <img
                  src="/blocks/features/feature-105/placeholder-6.svg"
                  alt="placeholder"
                  className="h-full w-full rounded-xl border object-cover"
                />
              </TabsContent>
