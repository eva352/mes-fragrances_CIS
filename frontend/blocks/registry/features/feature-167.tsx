...
const FEATURES_DATA = [
  {
    ...
    icon: SquarePen,
    image: "/blocks/features/feature-167/block-1.svg",
  },
  {
    ...
    icon: CalendarClock,
    image: "/blocks/features/feature-167/block-2.svg",
  },
  {
    ...
    image: "/blocks/features/feature-167/block-3.svg",
  },
];
        ...
        >
          <TabsList className="flex h-auto w-full flex-col rounded-none border-b bg-transparent p-0 lg:w-1/3 lg:border-r lg:border-b-0">
            {FEATURES_DATA.map((item, index, array) => (
              ...
              >
                <div className="absolute bottom-[-1px] left-0 z-10 h-[2px] w-0 bg-gradient-to-r from-blue-600 via-sky-300 to-transparent transition-all duration-300 group-data-[state=active]:w-1/2" />
