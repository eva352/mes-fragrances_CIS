  ...
  return (
    <div className={cn("max-lg:flex max-lg:gap-4", className)}>
      <div className="relative lg:py-6">
        <div
          className={`absolute h-full w-1 -translate-x-1/2 translate-y-11 bg-muted/50 bg-gradient-to-b max-lg:left-1/2 lg:top-1/2 lg:h-1 lg:w-full lg:translate-x-6 lg:-translate-y-1/2 lg:bg-gradient-to-r ${
