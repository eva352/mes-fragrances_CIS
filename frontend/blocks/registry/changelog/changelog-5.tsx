...
const changelogs = [
  {
    ...
    image: "/blocks/changelog/changelog-5/placeholder-1.svg",
    description: (
  ...
  },
  {
    ...
    image: "/blocks/changelog/changelog-5/placeholder-2.svg",
    description: (
      <div className="prose dark:prose-invert">
        <p>
  ...
  },
  {
    ...
    image: "/blocks/changelog/changelog-5/placeholder-3.svg",
    description: (
      <div className="prose dark:prose-invert">
        <p>
...
const Changelog5 = ({ className }: Changelog5Props) => {
