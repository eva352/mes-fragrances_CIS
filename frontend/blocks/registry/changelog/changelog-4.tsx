          ...
          <div className="flex flex-col gap-16">
            ...
            <div className="relative space-y-20">
              ...
              <div className="relative">
                ...
                <img
                  src="/blocks/changelog/changelog-4/placeholder-1.svg"
                  alt="placeholder"
                ...
                <div className="my-4 flex items-center gap-2">
                  <Avatar className="size-8 rounded-full border border-border">
                    <AvatarImage
                      src="/blocks/changelog/changelog-4/avatar-1.webp"
                      alt="placeholder"
                    />
                  </Avatar>
              ...
              <div className="relative">
                ...
                <img
                  src="/blocks/changelog/changelog-4/placeholder-2.svg"
                  alt="placeholder"
                  className="aspect-video rounded-md border border-border object-cover"
                />
                <div className="my-4 flex items-center gap-2">
                  <Avatar className="size-8 rounded-full border border-border">
                    <AvatarImage
                      src="/blocks/changelog/changelog-4/avatar-2.webp"
                      alt="placeholder"
                    />
                  </Avatar>
                  <time className="text-sm text-muted-foreground">
