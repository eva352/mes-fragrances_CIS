...
const Cta30 = ({ className }: Cta30Props) => {
  return (
    <section className={cn("bg-background", className)}>
      <div className="container flex flex-col items-center justify-center py-32">
        <div className="flex">
          <Avatar className="relative -mr-4 size-14 overflow-hidden rounded-full border">
            <AvatarImage src="/blocks/cta/cta-30/avatar-1.webp" alt="" />
            <AvatarFallback>AB</AvatarFallback>
          </Avatar>
          <Avatar className="relative -mr-4 size-14 overflow-hidden rounded-full border">
            <AvatarImage src="/blocks/cta/cta-30/avatar-2.webp" alt="" />
            <AvatarFallback>AB</AvatarFallback>
          </Avatar>
          <Avatar className="relative -mr-4 size-14 overflow-hidden rounded-full border">
            <AvatarImage src="/blocks/cta/cta-30/avatar-3.webp" alt="" />
            <AvatarFallback>AB</AvatarFallback>
          </Avatar>
          <Avatar className="relative -mr-4 size-14 overflow-hidden rounded-full border">
            <AvatarImage src="/blocks/cta/cta-30/avatar-4.webp" alt="" />
            <AvatarFallback>AB</AvatarFallback>
          </Avatar>
          <Avatar className="relative -mr-4 size-14 overflow-hidden rounded-full border">
            <AvatarImage src="/blocks/cta/cta-30/avatar-5.webp" alt="" />
            <AvatarFallback>AB</AvatarFallback>
          </Avatar>
          <Avatar className="relative -mr-4 size-14 overflow-hidden rounded-full border">
            <AvatarImage src="/blocks/cta/cta-30/avatar-6.webp" alt="" />
            <AvatarFallback>AB</AvatarFallback>
          </Avatar>
        </div>
        <header>
        ...
        <div className="group">
          <div className="relative flex items-center justify-center">
            ...
            <div className="absolute -right-25 -bottom-20 flex items-end md:-right-52">
              <Line />
              <p className="font-handwriting text-xl tracking-tight text-foreground mb-1 ml-1">
