import { ArrowUpRight, BookOpen, Zap } from "@/components/icons";
    ...
    <section className={cn("py-32", className)}>
      <div className="container">
        <div className="relative h-96 overflow-hidden rounded-xl border border-border">
          <img
            src="/blocks/cta/cta-26/andrew-kliatskyi-LYZxo7oVFOI-unsplash.webp"
            alt="placeholder"
            className="hidden h-full w-full object-cover dark:block"
          />
          <img
            src="/blocks/cta/cta-26/denis96-gmsf4Zo2-rY-unsplash.webp"
            alt="placeholder"
