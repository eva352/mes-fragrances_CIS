...
const AUTHOR: AuthorType = {
  image: "/blocks/blog/blogpost-6/avatar-1.webp",
  name: "Jane Doe",
  job: "CEO & Cofounder",
  description:
          ...
          <div className="flex w-full max-w-[40rem] flex-col gap-10">
            ...
            <div className="prose dark:prose-invert">
              ...
              <div className="w-full max-w-[40rem] overflow-hidden">
                <img
                  src="/blocks/blog/blogpost-6/placeholder-1.svg"
                  alt=""
              ...
              <div className="w-full max-w-[40rem] overflow-hidden">
                <img
                  src="/blocks/blog/blogpost-6/placeholder-2.svg"
                  alt=""
                  className="size-full object-cover object-center"
                />
              </div>
              ...
              <div className="w-full max-w-[40rem] overflow-hidden">
                <img
                  src="/blocks/blog/blogpost-6/placeholder-3.svg"
                  alt=""
                  className="size-full object-cover object-center"
                />
              </div>
              ...
              <div className="w-full max-w-[40rem] overflow-hidden">
                <img
                  src="/blocks/blog/blogpost-6/placeholder-4.svg"
                  alt=""
                  className="size-full object-cover object-center"
                />
              </div>
