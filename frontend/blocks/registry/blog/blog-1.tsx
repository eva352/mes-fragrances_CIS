...
const posts = [
  {
    ...
    label: "Design",
    href: "#",
    image: "/blocks/blog/blog-1/placeholder-dark-1.svg",
  },
  {
    id: "post-2",
    ...
    label: "Technology",
    href: "#",
    image: "/blocks/blog/blog-1/placeholder-dark-2.svg",
  },
  {
    id: "post-3",
    ...
    label: "Development",
    href: "#",
    image: "/blocks/blog/blog-1/placeholder-dark-3.svg",
  },
  {
    id: "post-4",
    ...
    label: "Marketing",
    href: "#",
    image: "/blocks/blog/blog-1/placeholder-dark-4.svg",
  },
  {
    id: "post-5",
    ...
    label: "Technology",
    href: "#",
    image: "/blocks/blog/blog-1/placeholder-dark-5.svg",
  },
  {
    id: "post-6",
    ...
    label: "Design",
    href: "#",
    image: "/blocks/blog/blog-1/placeholder-dark-6.svg",
  },
];
...
const Blog1 = ({ className }: Blog1Props) => {
  return (
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:gap-6 2xl:grid-cols-3">
          {posts.map((post) => (
            ...
            >
              ...
              <div className="mb-2 line-clamp-3 pt-4 text-lg font-medium break-words md:mb-3 md:pt-4 md:text-2xl lg:pt-4">
                {post.title}
              </div>
