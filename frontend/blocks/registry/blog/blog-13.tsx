        ...
        <div className="mt-20 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex flex-col">
            <div className="relative">
              <img
                src="/blocks/blog/blog-13/photo-1536735561749-fc87494598cb"
                alt="placeholder"
          ...
          <div className="flex flex-col">
            <div className="relative">
              <img
                src="/blocks/blog/blog-13/photo-1653288973812-81d1951b8127"
                alt="placeholder"
                className="aspect-video w-full rounded-lg object-cover"
              />
              <Badge
          ...
          <div className="flex flex-col">
            <div className="relative">
              <img
                src="/blocks/blog/blog-13/photo-1563952532949-3d1a874ad614"
                alt="placeholder"
                className="aspect-video w-full rounded-lg object-cover"
              />
              <Badge
