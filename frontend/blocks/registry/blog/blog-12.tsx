      ...
      <div className="container">
        ...
        <div className="mt-20 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <a className="rounded-xl border" href="#">
            <div className="p-2">
              <img
                src="/blocks/blog/blog-12/photo-1536735561749-fc87494598cb"
                alt="placeholder"
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  <Avatar className="size-9 rounded-full ring-1 ring-input">
                    <AvatarImage
                      src="/blocks/blog/blog-12/avatar-4.webp"
                      alt="placeholder"
                    />
                  </Avatar>
          ...
          <a className="rounded-xl border" href="#">
            <div className="p-2">
              <img
                src="/blocks/blog/blog-12/photo-1653288973812-81d1951b8127"
                alt="placeholder"
                className="aspect-video w-full rounded-lg object-cover"
              />
            </div>
            <div className="px-3 pt-2 pb-4">
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  <Avatar className="size-9 rounded-full ring-1 ring-input">
                    <AvatarImage
                      src="/blocks/blog/blog-12/avatar-1.webp"
                      alt="placeholder"
                    />
                  </Avatar>
          ...
          <a className="rounded-xl border" href="#">
            <div className="p-2">
              <img
                src="/blocks/blog/blog-12/photo-1563952532949-3d1a874ad614"
                alt="placeholder"
                className="aspect-video w-full rounded-lg object-cover"
              />
            </div>
            <div className="px-3 pt-2 pb-4">
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  <Avatar className="size-9 rounded-full ring-1 ring-input">
                    <AvatarImage
                      src="/blocks/blog/blog-12/avatar-3.webp"
                      alt="placeholder"
                    />
                  </Avatar>
