                ...
                <TableRow className="border-border/50">
                  ...
                  <TableHead className="text-center font-semibold text-foreground">
                    <div className="flex items-center justify-center gap-2">
                      <img
                        src="/blocks/compare/compare-9/openai-icon.svg"
                        alt="OpenAI"
                        width={16}
                        height={16}
                        className="h-4 w-4"
                  ...
                  <TableHead className="text-center font-semibold text-foreground">
                    <div className="flex items-center justify-center gap-2">
                      <img
                        src="/blocks/compare/compare-9/claude-icon.svg"
                        alt="Claude"
                        width={16}
                        height={16}
                        className="h-4 w-4"
                  ...
                  <TableHead className="text-center font-semibold text-foreground">
                    <div className="flex items-center justify-center gap-2">
                      <img
                        src="/blocks/compare/compare-9/gemini-icon.svg"
                        alt="Gemini"
                        width={16}
                        height={16}
                        className="h-4 w-4"
