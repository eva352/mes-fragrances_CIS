          ...
          <div className="z-10 mx-auto flex max-w-5xl flex-col items-center gap-6 text-center">
            ...
            <div className="mt-12 flex flex-col items-center gap-4 lg:mt-16">
              ...
              <div className="grid grid-cols-2 place-items-center items-center justify-center gap-6 opacity-80 sm:grid-cols-4 sm:gap-4">
                <img
                  src="/blocks/hero/hero-10/shadcn-ui-wordmark.svg"
                  alt="ShadCN UI"
                  className="h-6 dark:invert"
                />
                <img
                  src="/blocks/hero/hero-10/vercel-wordmark.svg"
                  alt="Vercel"
                  className="h-5 dark:invert"
                />
                <img
                  src="/blocks/hero/hero-10/supabase-wordmark.svg"
                  alt="Supabase"
                  className="h-6 dark:hidden"
                />
                <img
                  src="/blocks/hero/hero-10/supabase-wordmark-dark.svg"
                  alt="Supabase"
                  className="hidden h-6 dark:block"
                />
                <img
                  src="/blocks/hero/hero-10/tailwind-wordmark-light.svg"
                  alt="Tailwind CSS"
                  className="h-5 dark:hidden"
                />
                <img
                  src="/blocks/hero/hero-10/tailwind-wordmark-dark.svg"
                  alt="Tailwind CSS"
