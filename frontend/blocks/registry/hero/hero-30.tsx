      ...
      <div className="relative container">
        <div className="grid items-center gap-8 lg:grid-cols-2">
          ...
          <div className="relative mt-16 -mb-16 flex justify-center gap-4 lg:mt-0 lg:mb-0 lg:justify-end">
            {/* Mesh background */}
            <div className="absolute -inset-8 z-0 rounded-2xl bg-gradient-to-r from-primary/15 via-secondary/10 to-accent/15 opacity-70 blur-3xl"></div>

            {/* Images with relative positioning to appear above the mesh */}
            <div className="relative z-10">
              <img
                src="/blocks/hero/hero-30/placeholder-1.svg"
