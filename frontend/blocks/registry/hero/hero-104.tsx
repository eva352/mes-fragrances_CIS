        ...
        <div className="container max-w-[75rem]">
          <div className="flex gap-8">
            <div className="mx-auto max-w-[50rem] lg:max-w-full">
              <h1 className="mb-[0.625rem] text-center font-poppins text-5xl leading-tight font-semibold tracking-[-1px] sm:text-[3.375rem] md:text-[5.625rem] md:leading-[6.18rem] lg:text-left">
            ...
            <div className="hidden lg:block">
              <div className="grid grid-cols-[repeat(2,10.375rem)] grid-rows-[2.4375rem_7.18rem_3.187rem_7.125rem_3.75rem_4.625rem] gap-x-8 gap-y-[1.375rem] bg-[radial-gradient(closest-side,var(--color-gray-300),var(--color-transparent))] bg-[length:100%_100%] bg-center bg-no-repeat">
                <div className="relative col-[1/2] row-[1/3]">
                  <img
                    src="/blocks/hero/hero-104/placeholder-1.svg"
                    alt=""
                    className="object-fit h-full w-full rounded-2xl opacity-80 blur-md"
                  />
                  <div className="absolute bottom-0 flex min-w-[15rem] gap-3 rounded-2xl bg-background p-3 shadow-2xl">
                    <img
                      src="/blocks/hero/hero-104/avatar-1.webp"
                      alt=""
                ...
                <div className="col-[2/3] row-[2/4]">
                  <div className="flex h-full w-full flex-col justify-between rounded-2xl bg-background p-2 shadow-lg">
                ...
                <div className="col-[2/3] row-[4/-2]">
                  <div className="flex h-full w-full flex-col justify-between rounded-2xl bg-background p-4 shadow-lg">
                    <div>
                ...
                <div className="col-[1/2] row-[-1/-3]">
                  <img
                    src="/blocks/hero/hero-104/placeholder-4.svg"
                    alt=""
        ...
        <DialogContent className="sm:max-w-[800px]">
          ...
          <div className="aspect-video">
            <iframe
              ...
              src="/blocks/hero/hero-104/your-video-id"
